...
public class MainActivity extends AppCompatActivity implements Adapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new REST().execute("https://oziz.ffos.hr/nastava20202021/msostaric_20/v3API/v1/utakmice");
    ...
    public void onItemClick(Utakmica utakmica) {
        Log.d("Stigao", "---");
        Toast.makeText(this, "Rezultat: " + String.valueOf(utakmica.getRezultat()),Toast.LENGTH_LONG).show();
    }
